...
output AZURE_MONITOR_ACTION_GROUP_NAME string = resources.outputs.healthActionGroupName
output AZURE_MONITOR_ACTION_GROUP_ID string = resources.outputs.healthActionGroupResourceId
output LOG_ANALYTICS_WORKSPACE_NAME string = resources.outputs.logAnalyticsWorkspaceName
output LOG_ANALYTICS_WORKSPACE_ID string = resources.outputs.logAnalyticsWorkspaceResourceId
